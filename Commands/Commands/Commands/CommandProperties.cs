...
namespace Vulcain.Core.Commands
{
    ...
    public class CommandProperties
    {
        ...
        internal const ExecutionIsolationStrategy default_executionIsolationStratgey = Vulcain.Core.Commands.ExecutionIsolationStrategy.Thread;
      ...
      private IDynamicProperty<TValue> Get<TValue>(string name, TValue defaultValue) where TValue : struct
        {
            return DynamicConfiguration.Factory.AsChainedProperty<TValue>(
